...
exports.initHistory = function( schema, callback ) {
	
	if ( callback ) {
		
		schema.methods.createHistory = function() {
			
			var hist = createHistory.apply( this, arguments );
			
			return hist && callback.call( this, hist );
		}
	}
	else {
